...
import com.hz.yk.doclet.support.ClassInfo;
import com.hz.yk.doclet.support.FieldInfo;
import com.hz.yk.doclet.support.MethodInfo;
import com.hz.yk.doclet.support.ParameterInfo;
    ...
    private static void processMethods(RootDoc root, Map<String, ClassInfo> classDescs, ClassInfo classInfo,
        ...
        for (MethodDoc method : methods) {
            ...
            for (ParamTag tag : method.paramTags()) {
                ...
                methodInfo.addParameterInfo(ParameterInfo.create(tag.parameterName(), tag.parameterComment(),
                        parameter != null ? parameter.type().qualifiedTypeName() : "unknow"));
            }
