...
//                System.getProperty("user.dir") + "/src/main/java/" + "com/hz/yk/concurrent/aqs/BooleanMutex.java"};
      ...
      String javaFile2=System.getProperty("user.dir") + "/src/main/java/" + "com/hz/yk/yk/nio/BaiduReader.java";
      String javaFile3=System.getProperty("user.dir") + "/src/main/java/" + "com/hz/yk/yk/nio/UseFloatBuffer.java";
        String[] docArgs = new String[]{"-doclet", "MyHtmlDoclet", "-d",
