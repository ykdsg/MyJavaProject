 ...
 * @date 2021/7/2
 */
public class IdGeneratorV0 {

    private static final Logger logger = LoggerFactory.getLogger(IdGeneratorV0.class);
    ...
    public static String generate() {
        ...
        try {
            ...
            if (tokens.length > 0) { hostName = tokens[tokens.length - 1]; }
