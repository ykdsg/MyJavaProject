...
import static com.hz.yk.design.ch64.State.CAPE;
import static com.hz.yk.design.ch64.State.FIRE;
import static com.hz.yk.design.ch64.State.SMALL;
import static com.hz.yk.design.ch64.State.SUPER;
...
public class MarioStateMachine {
    ...
    private static final State[][] TRANSITION_TABLE = { { SUPER, CAPE, FIRE, SMALL }, { SUPER, CAPE, FIRE, SMALL },
                                                        { CAPE, CAPE, CAPE, SMALL }, { FIRE, FIRE, FIRE, SMALL } };
    private static final int[][] ACTION_TABLE = { { +100, +200, +300, +0 }, { +0, +200, +300, -100 }, { +0, +0, +0, -200 },
                                                  { +0, +0, +0, -300 } };
