...
/**
 * 当消息的重要程度等于某一个级别的时候，写logger1，否则写logger2。
 * Created by wuzheng.yk on 16/12/2.
 */
public class EqualLogger implements Logger {
    private final Logger logger1;
    private final Logger logger2;
    private final int lvl;

    public EqualLogger(int lvl,Logger logger1, Logger logger2) {
    ...
    public void printException(Throwable e){
        if(lvl== LogLevelConstant.ERROR) logger1.printException(e);
